...
ข้อผิดพลาด HTTP ที่ไม่มีรหัสข้อความมาตรฐานจะแสดง status ที่แปลได้ ไม่แสดง
ข้อความภาษาไทยที่ server ส่งมาโดยไม่มี contract ภาษา ส่วนรายละเอียดเฉพาะ
ควรเพิ่มเป็น error code พร้อมคำแปลเมื่อ Backend รองรับ
...
- ส่ง `Accept-Language` ให้ AI/route API แต่ไม่สมมติว่า server รองรับการแปล.
  ชื่อคลาส AI และทิศทางที่รองรับแปลฝั่งแอป ส่วนคะแนนและผลตรวจยังมาจาก API.
